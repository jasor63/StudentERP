    ...
    <div className="sidebar d-flex flex-column justify-content-between border-end p-3 vh-100" style={{ width: "18rem" }}>
      <div>
        ...
        <ul className="nav nav-pills flex-column p-0 m-0">
          ...
          <li className="nav-item p-1">
            <Link to="/admin/dashboard/upload-timetable" className="nav-link text-black">
              <i className="bi bi-calendar-event me-2 fs-5"></i>
              <span className="fs-5">Upload Timetable</span>
            </Link>
          </li>

          <li className="nav-item p-1">
            <Link to="/admin/dashboard/manage-subjects" className="nav-link text-black">
              <i className="bi bi-journal-plus me-2 fs-5"></i>
              <span className="fs-5">Manage Subjects</span>
            </Link>
          </li>
